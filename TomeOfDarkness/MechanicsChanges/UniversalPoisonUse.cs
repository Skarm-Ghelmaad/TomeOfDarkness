...
namespace TomeOfDarkness.MechanicsChanges
{
    internal class UniversalPoisonUse
    {
        ...
        public static void ConfigureUniversalPoisonUse()
        {
            ...
            var Assassin_Create_Poison_Ability_Str_Buff_Repeated_Apply_Action = HlEX.CreateContextActionRepeatedApplyBuff(Assassin_Create_Poison_Ability_Str_Buff_Effect, HlEX.CreateContextDuration(HlEX.CreateContextValue(NewAbilitySharedValue.PoisonFrequency), DurationRate.Rounds, DiceType.Zero, HlEX.CreateContextValue(0)), HlEX.CreateContextValue(NewAbilitySharedValue.PoisonConcentration), false, true, false, false, false, false);
            var Assassin_Create_Poison_Ability_Dex_Buff_Repeated_Apply_Action = HlEX.CreateContextActionRepeatedApplyBuff(Assassin_Create_Poison_Ability_Dex_Buff_Effect, HlEX.CreateContextDuration(HlEX.CreateContextValue(NewAbilitySharedValue.PoisonFrequency), DurationRate.Rounds, DiceType.Zero, HlEX.CreateContextValue(0)), HlEX.CreateContextValue(NewAbilitySharedValue.PoisonConcentration), false, true, false, false, false, false);
            var Assassin_Create_Poison_Ability_Con_Buff_Repeated_Apply_Action = HlEX.CreateContextActionRepeatedApplyBuff(Assassin_Create_Poison_Ability_Con_Buff_Effect, HlEX.CreateContextDuration(HlEX.CreateContextValue(NewAbilitySharedValue.PoisonFrequency), DurationRate.Rounds, DiceType.Zero, HlEX.CreateContextValue(0)), HlEX.CreateContextValue(NewAbilitySharedValue.PoisonConcentration), false, true, false, false, false, false);
            ...
            var Assassin_Create_Poison_Ability_Str_Apply_Buff_Ranks_Action = HlEX.CreateContextActionApplyBuffRanks(Assassin_Create_Poison_Ability_Str_Buff, HlEX.CreateContextDuration(1, DurationRate.Days), HlEX.CreateContextValue(NewAbilitySharedValue.PoisonStickiness), false, true, false, true, false, true);
            var Assassin_Create_Poison_Ability_Dex_Apply_Buff_Ranks_Action = HlEX.CreateContextActionApplyBuffRanks(Assassin_Create_Poison_Ability_Dex_Buff, HlEX.CreateContextDuration(1, DurationRate.Days), HlEX.CreateContextValue(NewAbilitySharedValue.PoisonStickiness), false, true, false, true, false, true);
            var Assassin_Create_Poison_Ability_Con_Apply_Buff_Ranks_Action = HlEX.CreateContextActionApplyBuffRanks(Assassin_Create_Poison_Ability_Con_Buff, HlEX.CreateContextDuration(1, DurationRate.Days), HlEX.CreateContextValue(NewAbilitySharedValue.PoisonStickiness), false, true, false, true, false, true);

            // Clear the abilities by setting them with the new components.

            Assassin_Create_Poison_Ability_Str.TemporaryContext(bp => {
                bp.SetComponents(new BlueprintComponent[] { HlEX.CreateRunActions(Assassin_Create_Poison_Ability_Str_Apply_Buff_Ranks_Action), Assassin_Create_Poison_Ability_Any_Ability_Resource_Logic, Assassin_Create_Poison_Ability_Any_Ability_Caster_Has_No_Facts, Assassin_Create_Poison_Ability_Any_Context_Set_Ability_Params, Assassin_Create_Poison_Ability_Any_Context_Calc_Shared_Value_Stickiness, Assassin_Create_Poison_Ability_Any_Context_Calc_Shared_Value_Concentration, Assassin_Create_Poison_Ability_Any_Context_Calc_Shared_Value_Frequency, Assassin_Create_Poison_Ability_Any_Context_Calc_Shared_Value_Recovery });
            });
            ...
            Assassin_Create_Poison_Ability_Dex.TemporaryContext(bp => {
                bp.SetComponents(new BlueprintComponent[] { HlEX.CreateRunActions(Assassin_Create_Poison_Ability_Dex_Apply_Buff_Ranks_Action), Assassin_Create_Poison_Ability_Any_Ability_Resource_Logic, Assassin_Create_Poison_Ability_Any_Ability_Caster_Has_No_Facts, Assassin_Create_Poison_Ability_Any_Context_Set_Ability_Params, Assassin_Create_Poison_Ability_Any_Context_Calc_Shared_Value_Stickiness, Assassin_Create_Poison_Ability_Any_Context_Calc_Shared_Value_Concentration, Assassin_Create_Poison_Ability_Any_Context_Calc_Shared_Value_Frequency, Assassin_Create_Poison_Ability_Any_Context_Calc_Shared_Value_Recovery });
            });
            ...
            Assassin_Create_Poison_Ability_Con.TemporaryContext(bp => {
                bp.SetComponents(new BlueprintComponent[] { HlEX.CreateRunActions(Assassin_Create_Poison_Ability_Con_Apply_Buff_Ranks_Action), Assassin_Create_Poison_Ability_Any_Ability_Resource_Logic, Assassin_Create_Poison_Ability_Any_Ability_Caster_Has_No_Facts, Assassin_Create_Poison_Ability_Any_Context_Set_Ability_Params, Assassin_Create_Poison_Ability_Any_Context_Calc_Shared_Value_Stickiness, Assassin_Create_Poison_Ability_Any_Context_Calc_Shared_Value_Concentration, Assassin_Create_Poison_Ability_Any_Context_Calc_Shared_Value_Frequency, Assassin_Create_Poison_Ability_Any_Context_Calc_Shared_Value_Recovery });
            });
